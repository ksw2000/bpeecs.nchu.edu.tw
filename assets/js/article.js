  ...
  if (what == 'management') {
    ...
    this.render = function (data) {
      ...
      for (var i = 0; i < len; i++) {
        ...
        ret += "<div class=\"candy-header\"><span>\u5EFA\u7ACB\u65BC</span><span class=\"red\">".concat(data[i].Create_time, "</span></div>");
        ret += "<div class=\"candy-header\"><span>\u6700\u5F8C\u7DE8\u8F2F</span><span class=\"orange\">".concat(data[i].Last_modified, "</span></div>");
...
function loadPublicNewsById(id) {
  return new Promise(function (resolve, reject) {
    loadNewsById(id).then(function (data) {
      ...
      ret.text += "<div class=\"candy-header\"><span>\u5EFA\u7ACB\u65BC</span><span class=\"red\">".concat(data.Create_time, "</span></div>");
      ret.text += "<div class=\"candy-header\"><span>\u4FEE\u6539\u65BC</span><span class=\"orange\">".concat(data.Last_modified, "</span></div>");
